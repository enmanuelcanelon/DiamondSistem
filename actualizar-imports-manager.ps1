# Script para actualizar imports en frontend-manager
# Reemplaza imports relativos por @shared

$files = Get-ChildItem -Path "frontend-manager\src" -Recurse -Include "*.jsx","*.js" | Where-Object { $_.FullName -notmatch "node_modules" }
