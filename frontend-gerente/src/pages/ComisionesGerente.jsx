      ...
      <div className="bg-white rounded-lg shadow-sm p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            className="px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition flex items-center gap-2 disabled:bg-gray-400 disabled:cursor-not-allowed"
          >
            {descargandoPDF ? (
              <>
          ...
          {vendedores.map((vendedorData) => {
            ...
            return (
              <div key={vendedor.id} className="bg-white rounded-lg shadow-sm overflow-hidden">
                {/* Header del Vendedor */}
                <div
                  className="p-4 bg-gradient-to-r from-purple-50 to-purple-100 border-b border-purple-200 cursor-pointer hover:from-purple-100 hover:to-purple-200 transition"
