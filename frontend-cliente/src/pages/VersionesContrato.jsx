            ...
            return (
              <div
                ...
                className={`bg-white rounded-xl shadow-sm border p-6 ${
                  esUltimaVersion ? 'ring-2 ring-gray-900' : ''
                }`}
              >
                {/* Badge de versi�n actual */}
                {esUltimaVersion && (
                  <div className="mb-4">
                    <span className="px-3 py-1 bg-gray-100 text-gray-900 text-xs rounded-full font-semibold">
                      ? Versi�n Actual
                    </span>
                  </div>
                )}
                ...
                <div className="flex items-start justify-between gap-6">
                  ...
                  <div className="flex flex-col items-end gap-2">
                    <button
                      ...
                      className="flex items-center gap-2 px-4 py-2 bg-gray-900 hover:bg-gray-800 text-white rounded-lg transition font-medium"
                    >
