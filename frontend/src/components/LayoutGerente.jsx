...
function LayoutGerente() {
  ...
  const navigation = [
    { name: 'Dashboard', href: '/gerente', icon: BarChart3 },
    { name: 'Vendedores', href: '/gerente/vendedores', icon: Users },
    { name: 'Contratos', href: '/gerente/contratos', icon: FileText },
    { name: 'Ofertas', href: '/gerente/ofertas', icon: TrendingUp },
    { name: 'Pagos', href: '/gerente/pagos', icon: DollarSign },
    { name: 'Calendario', href: '/gerente/calendario', icon: Calendar },
  ];
