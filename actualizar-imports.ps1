# Script para actualizar imports en frontend-vendedor
# Reemplaza imports relativos por @shared

$files = Get-ChildItem -Path "frontend-vendedor\src" -Recurse -Include "*.jsx","*.js" | Where-Object { $_.FullName -notmatch "node_modules" }
