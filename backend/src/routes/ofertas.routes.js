      ...
      // Crear oferta
       const nuevaOferta = await prisma.ofertas.create({
         data: {
           ...
           // IMPORTANTE: Guardar fecha con hora mediodía UTC para evitar problemas de zona horaria
           // Usamos T17:00:00Z (5 PM UTC) = 12 PM hora de Miami (EST)
           // Esto asegura que la fecha sea correcta en cualquier zona horaria
           fecha_evento: new Date(`${datos.fecha_evento}T17:00:00Z`),
